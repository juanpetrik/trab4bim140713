 ...
 *
 *         Classe responsável por realizar a conversão da data..
 */
@FacesConverter(value = LocalDateTimeConverter.ID)
public class LocalDateTimeConverter extends DateTimeConverter {

	public static final String ID = "br.com.petrik.uteis.LocalDateTimeConverter";

	// Converte uma String para uma data local
	@Override
	...
	// Converte uma String especificada para um Objeto
	@Override
